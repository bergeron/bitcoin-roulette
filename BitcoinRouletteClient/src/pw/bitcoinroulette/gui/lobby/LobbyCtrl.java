package pw.bitcoinroulette.gui.lobby;
	...
	public void login() {
		...
		final Action action = new AbstractAction("Login") {
			...
			public void handle(ActionEvent ae) {
				...
				try {
					main.core.rouletteServer.login(username.getText(), password.getText());
	...
	public void register() {
		...
		final Action action = new AbstractAction("Register") {
			...
			public void handle(ActionEvent ae) {
				...
				try {
					main.core.rouletteServer.register(username.getText(), password.getText());
				} catch (RemoteException e) {
